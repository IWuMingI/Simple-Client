package cn.wuming.simple.gui.clickgui;

import cn.wuming.simple.utils.GLUtil;
import cn.wuming.simple.utils.fontRenderer.GlyphPageFontRenderer;
...
public class SimpleRendererImpl implements IRenderer {
    private GlyphPageFontRenderer renderer;

    public SimpleRendererImpl(GlyphPageFontRenderer renderer) {
